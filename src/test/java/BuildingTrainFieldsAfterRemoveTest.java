...
public class BuildingTrainFieldsAfterRemoveTest {
    ...
    public void numberOfPassengersTest() {
        ...
        Integer sum = numberOfPassengers;
    ...
    public void maximumLoadingWeightForGoodsTest() {
        ...
        Integer sum = maximumLoadingWeight;
        Assertions.assertEquals(sum, cal);
    }
    ...
    public void tractiveEffortTest() {
        ...
        Integer sum = tractiveEffort - ((numberOfPassengers * 75) + maximumLoadingWeight );
        Assertions.assertEquals(sum, cal);
    }
    ...
    public void conductorsTest(){
        ...
        Integer sum = (int) Math.ceil( (float) (numberOfPassengers) / 50);
        Assertions.assertEquals(sum, cal);
    }
}
