...
public class BuildingTrainFieldsAfterAddTwoWagonTest {
    ...
    public static void init() {
        ...
        emptyWeight2 = 25000;
        length2 = 26.5f;
        numberOfPassengers2 = 120;
        maximumLoadingWeight2 = 16000;
